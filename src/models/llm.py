...
class LLMEngine:
    """Handles loading the LLM with 4-bit quantization and generating SQL."""
    ...
    def _load_model(self):
        """Loads the model and tokenizer with BitsAndBytes configuration."""
    ...
    def generate(self, prompt: str) -> tuple[str, int, int]:
        ...
        Returns: (cleaned_sql, input_token_count, output_token_count)
        """
